    ...
    <div>
      ...
      <Navbar/>
        <Routes>
          ...
          <Route path="/mens/:sub" element={<Shopcategory category="men" />} />
          <Route path="/womens/:sub" element={<Shopcategory category="women" />} />
          <Route path="/kids/:sub" element={<Shopcategory category="kid" />} />
